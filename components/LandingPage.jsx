...
export default function LandingPage() {
  return (
    <section>
        <section id="home" className="h-max md:h-screen w-full flex flex-col justify-center items-center text-center px-4 mt-20">
        <motion.div
        ...
        >
            ...
            a Student and a Software Enginer.
        </motion.h1>
      ...
      >
        ...
        {/* Metrik 2 */}
        <div className="flex-1 p-5 text-center">
          <p className="text-2xl md:text-3xl font-bold text-purple-700">15+</p>
