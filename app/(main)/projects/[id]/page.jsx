...
import { FiGithub, FiExternalLink, FiClipboard, FiLayers } from 'react-icons/fi';
    ...
    <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
      <div className="flex items-start gap-4">
        ...
        <div>
          ...
          {isLink ? (
            <a href={value} target="_blank" rel="noopener noreferrer" className="text-lg font-semibold text-blue-600 hover:underline break-all">
              {value.replace('https://', '')}
            </a>
          ) : (
